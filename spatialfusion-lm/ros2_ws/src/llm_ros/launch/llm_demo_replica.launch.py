...
def setup_replica_topics_and_bag(context, *args, **kwargs):
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('bag_path', default_value='/datasets/replica_office2'),
        ...
        OpaqueFunction(function=setup_replica_topics_and_bag),
